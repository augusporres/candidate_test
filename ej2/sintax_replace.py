...
# Correr asi:
# python3 sintax_replace.py testcase.v
import re
from sys import argv

if len(argv) == 2:
    testcase_file = argv[1]
    with open(testcase_file, 'r') as f, open('my_expected.v', 'w') as d, open('my_memdump0.mem', 'w') as memdump:
        # Corrijo sintaxis
        file_content = f.read()
    ...
    print("Falta ingresar archivo testcase.v a reemplazar!")
